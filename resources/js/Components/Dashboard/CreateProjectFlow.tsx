      ...
      <Dialog.Content>
        ...
        <div className="px-5 pt-2 pb-4">
          <Text className="kb-content-secondary text-sm leading-relaxed">
            Projects help you organize your application environments, deployments, infrastructure
            and resources. Each project will automatically include staging and production
            environments.
          </Text>
        </div>
