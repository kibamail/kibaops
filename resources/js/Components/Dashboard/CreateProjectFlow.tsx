          ...
          <Dialog.Content>
              ...
              <div className="px-5 pt-2 pb-4">
                  <Text className="kb-content-secondary text-sm leading-relaxed">
                      Projects help you organize your application environments,
                      deployments, infrastructure and resources. Each project
                      will automatically include staging and production
                      environments.
                  </Text>
              </div>
              ...
              <form onSubmit={submit}>
                  <div className="px-5 pb-5 space-y-4">
                      ...
                      <TextField.Root name="slug" value={data.slug} disabled>
                          ...
                          <TextField.Hint>
                              This will be automatically generated from your
                              project name
                          </TextField.Hint>
                          {errors.slug && (
                              <TextField.Error>{errors.slug}</TextField.Error>
                          )}
                      </TextField.Root>
                  </div>
