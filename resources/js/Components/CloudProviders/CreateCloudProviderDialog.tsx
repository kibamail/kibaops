      ...
      <Dialog.Root open={isOpen} onOpenChange={onOpenChange}>
          <Dialog.Content>
              <Dialog.Header>
                  ...
                  <VisuallyHidden>
                      <Dialog.Description>
                          Connect a new cloud provider to your workspace
                      </Dialog.Description>
                  </VisuallyHidden>
              </Dialog.Header>
              ...
              <div className="px-5 pt-2 pb-4">
                  <Text className="kb-content-secondary text-sm leading-relaxed">
                      Connect your cloud provider to start provisioning
                      infrastructure. Your credentials are securely stored and
                      encrypted. You can connect multiple cloud providers to a
                      single workspace.
                  </Text>
              </div>
              ...
              <form onSubmit={submit} autoComplete="off">
                  <div className="px-5 pb-5 space-y-4">
                      ...
                      >
                          ...
                          {errors.type && (
                              <Select.Error>{errors.type}</Select.Error>
                          )}
                      </Select.Root>
                      ...
                      >
                          ...
                          {errors.name && (
                              <TextField.Error>{errors.name}</TextField.Error>
                          )}
                      </TextField.Root>
                                  ...
                                  <div className="mb-6 flex flex-col">
                                      ...
                                      <div className="space-y-2">
                                          ...
                                          <Text className="kb-content-tertiary text-sm">
                                              <a
                                                  href={
                                                      selectedProvider.documentationLink
                                                  }
                                                  target="_blank"
                                          ...
                                          >
                                              {field.type === "textarea" ? (
                                                  <div className="space-y-2">
                                                      ...
                                                      />
                                                      {errors[
                                                          `credentials.${index}` as keyof typeof errors
                                                      ] && (
                                                          <TextField.Error>
                                                              {
                                                                  errors[
                      ...
                      {errors.credentials &&
                          typeof errors.credentials === "string" && (
                              <div className="kb-content-negative text-sm">
                                  {errors.credentials}
                              </div>
                          )}
                  </div>
                  ...
                  <Dialog.Footer className="flex justify-between">
                      ...
                      <Button
                          ...
                          loading={processing}
                          disabled={
                              !data.type || !data.name || !selectedProvider || !workspaceId
                          }
                      >
                          Connect provider
                      </Button>
