...
export default function Index({ auth, workspace, projects }: PageProps<{ workspace: Workspace, projects: Project[] }>) {
    return (
        <AuthenticatedLayout
                                    ...
                                    {projects.map((project) => (
                                        <div key={project.id} className="border rounded-lg p-4">
                                            ...
                                            <div className="flex space-x-2 mt-4">
                                                <Link
                                                    href={route('workspaces.projects.show', { workspace: workspace.id, project: project.id })}
