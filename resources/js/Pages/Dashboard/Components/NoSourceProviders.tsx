            ...
            <div className="flex flex-col items-center">
                ...
                <div className="mt-4 flex flex-col items-center max-w-lg">
                    ...
                    <Text className="text-center kb-content-tertiary mt-4">
                        You have not linked any source code providers to this
                        workspace yet. Once you do, you'll be able to deploy
                        your applications directly from your repositories. You may
                        connect multiple source code providers to a single workspace.
                    </Text>
                </div>
