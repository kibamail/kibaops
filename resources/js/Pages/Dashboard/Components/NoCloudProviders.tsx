...
import type { CloudProviderType, CloudProviderInfo, PageProps } from "@/types";
import { CloudWaterdropIcon } from "@/Components/Icons/cloud-waterdrop.svg";
import { usePage } from "@inertiajs/react";
import { useState } from "react";
import { CreateCloudProviderDialog } from "@/Components/CloudProviders/CreateCloudProviderDialog";
...
export function NoCloudProviders() {
    const { cloudProviders, activeProject, activeWorkspaceId } = usePage<PageProps>().props;
    const [isDialogOpen, setIsDialogOpen] = useState(false);
    const [selectedProviderType, setSelectedProviderType] = useState<CloudProviderType | undefined>(undefined);
    ...
    return (
        <>
            ...
            <CreateCloudProviderDialog
                ...
                workspaceId={activeWorkspaceId || activeProject?.workspace_id || ''}
