...
export default function Dashboard() {
  const { cloudProvidersCount, sourceCodeConnectionsCount, clustersCount, projects } =
  ...
  const dashboardStates = [
    ...
    {
      condition: cloudProvidersCount > 0 && clustersCount > 0 && sourceCodeConnectionsCount === 0,
    ...
    },
    {
      condition:
        ...
        clustersCount > 0 &&
        projects.length === 0,
      component: <NoWorkspaceProjects onCreateProjectClick={onCreateProjectClick} />,
    },
  ];
